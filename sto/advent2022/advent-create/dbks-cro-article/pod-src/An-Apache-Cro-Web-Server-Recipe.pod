...
=head2 U<Building a Cro App and Deploying It On an Apache Web Server>

=head2 Author: Tony O'Dell

=begin para
This article will encompass building a Cro application (with DB and templating), configuring your apache web server, and ensuring your app is running with systemd.
=end para

=head2 Part 1 - Building the Cro app
