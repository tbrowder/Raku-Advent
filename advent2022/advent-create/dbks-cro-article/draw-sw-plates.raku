...
# title of output pdf
my $new-doc   = "Shorelie-114-switches.pdf";
# title on cover
my $new-title = "Switches and light controls, 114 Shoreline Drive";

if not @*ARGS.elems {
    print qq:to/HERE/;
    Usage: {$*PROGRAM.basename} go

    Reads file 'sw-lists' which contains data on owner
    preferences for switch and light controls.
...
my $ifil = "sw-lists";
unless $ifil.IO.r { die("FATAL: No such file '$ifil'") };
