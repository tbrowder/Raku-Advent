...
highlight some details learned by experience during recent work with
Rakudo NQP files. The work involves implementing some
not-yet-implemented (NYI) Perl 6 POD features, and I hope to merge the
changes soon.

## Preparation

The NQP files used are kept in a git repository at
[https://github.com/rakudo/rakudo/src/Perl6](https://github.com/rakudo/rakudo/tree/master/src/Perl6). See
